  ...
  return (
    <div name="home" className='w-full h-screen px-4 bg-[#0a192f]'>
     ...
     <div className='max-w-[1000px] grid sm:grid-cols-2 gap-[50px] mx-auto '>
       <div className='w-full sm:mt-[200px] sm:right-0'>
       ...
       <div className='w-full sm:mt-[200px] sm:right-0 text-[#8892b0]'>
       <img className='p-5 sm:w-full sm:h-[350px] rounded-[50px]' src={Ram} alt='Ram'/>
       </div>
     </div>
    </div>
  )
